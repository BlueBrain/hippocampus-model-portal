      ...
      <div className="w-full max-w-screen-xl mx-auto xl:px-0 xs:px-8">
        ...
        <div className="flex flex-wrap justify-between mt-4">
          <div className="w-full sm:w-1/3 pr-12 mb-4 xs:mb-12">
            <Link href="https://www.epfl.ch/research/domains/bluebrain/">
              Blue Brain Project
            </Link>
            <br />
            <br />
            ...
            <div className="mt-4">
              ...
              <div className="flex space-x-2 mt-2">
                <Link href="https://x.com/bluebrainpjt?lang=en">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1.5rem" width="1.5rem" xmlns="http://www.w3.org/2000/svg">
