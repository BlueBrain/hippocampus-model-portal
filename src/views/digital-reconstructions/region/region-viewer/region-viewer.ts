...
export default class VolumeViewer {
  ...
  private initMaterials() {
    this.material = {
      ...
      SLM: new MeshLambertMaterial({ color: parseCssColor("black"), side: DoubleSide }),
      SR: new MeshLambertMaterial({ color: parseCssColor("black"), side: DoubleSide }),
      SP: new MeshLambertMaterial({ color: parseCssColor("black"), side: DoubleSide }),
      SO: new MeshLambertMaterial({ color: parseCssColor("black"), side: DoubleSide }),
    }
  }
