...
const ConnectionAnatomyView: React.FC = () => {
  ...
  */}
      ...
      >
        ...
        >
          <p>
            Synaptic boutons, or simply, boutons, are enlargements of the axon, visible with light microscopy, that represent putative synaptic contacts. Bouton density is normally expressed as the number of boutons per 100 μm.
          </p>
          <BoutonDenisityTable />
        </Collapsible>
        ...
        >
          <p>We can express the synapse divergence also in relation to the postsynaptic target. Here, we calculate the percentage of synapses made by a morphological type onto pyramidal cells or interneurons.</p>
        ...
        >
          <p>We present here the distribution of synapse divergence per morphological type across the different layers.</p>
          <SynDivLayTable />
        </Collapsible>
