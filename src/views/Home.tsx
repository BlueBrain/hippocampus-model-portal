  ...
  <div className="flex flex-col">
    ...
    >
      <div className="p-8 mt-24 mw-full max-w-screen-xl mx-auto xl:px-0 xs:px-8">
        ...
        <h3 className="text-bbp text-l mb-2 text-center">
          Explore the existing Hippocampus model and all its parts!
        </h3>
        <Disclaimer />
        ...
        <div className="w-full lg:w-1/5 md:w-1/3 md:px-2 xs:mb-4">
          <SectionCard
            ...
            description={
              <div>
                <p>
                  The first step of the reconstruction of the hippocampus
                  involves the collection of experimental datasets from our
                  affiliated and collaborators’ laboratories as well as from
                  published literature sources worldwide. Available data on
                  these brain regions are sparse and heterogeneous, and much of
                  our work concerned the curation and organization of the data.
                </p>
              </div>
            }
            links={[
        ...
        <div className="w-full lg:w-1/5 md:w-1/3 md:px-2 xs:mb-4">
          <SectionCard
            ...
            description={
              <div>
                <p>
                  The second step of the reconstruction converts the sparse
                  experimental datasets to dense datasets, required to fully
                  reconstruct the hippocampus model. We applied several
                  strategies to predict the missing data: algorithms,
        ...
        <div className="w-full lg:w-1/5 md:w-1/3 md:px-2 xs:mb-4">
          <SectionCard
            ...
            description={
              <div>
                <p>
                  The third step of the reconstruction generates an instance of
                  the hippocampus model. Most of the model parameters were
                  sampled from the distributions defined in the dense datasets
                  of step two. For this reason, each model instance is unique
                  within the biological ranges and could be considered to be
                  derived from a specific individual.
                </p>
              </div>
            }
            links={[
        ...
        <div className="w-full lg:w-1/5 md:w-1/3 md:px-2 xs:mb-4">
          <SectionCard
            ...
            description={
              <div>
                <p>
                  We extensively validated each model component and the final
                  network to assess the validity of the model. Successful
                  validations support the idea that the model can go beyond the
                  initial set of data and show emergent properties. Validation
                  failures may indicate wrong model assumptions or
                  incompatibility between model and validation datasets.
                  Validation failures provide useful information for us to
        ...
        <div className="w-full lg:w-1/5 md:w-1/3 md:px-2 xs:mb-4">
          <SectionCard
            ...
            description={
              <div>
                <p>
                  Each model parameter or behavior that has not been described
                  experimentally could be considered a prediction. We already
                  mentioned that most of the predicted parameters and behaviors
                  arise during the reconstruction data step. Here, we focus on
                  the predictions derived from the simulation experiments we
                  carried out.
                </p>
              </div>
            }
